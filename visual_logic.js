    ...
    checkARMode(function() {
        enterARMode('ORIGIN', true, function() {
            ...
            arHitTest(function() {
                ...
                setObjTransform('LateralFace', false, 'position', arHitPoint('xyz'), false);
                setObjTransform('LateralFace', false, 'rotation', arHitNormal('xyz'), false);
            }, function() {}, 0);
        }, function() {}, function() {
            console.log('AR Fail');
        });
